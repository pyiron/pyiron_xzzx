...
latex_documents = [
  ('index', 'pyiron_database.tex', u'pyiron_database Documentation',
...
man_pages = [
    ('index',
     'pyiron_database',
     u'pyiron_database Documentation',
...
main(['-e', '-o', 'apidoc', '../pyiron_database', '--force'])
